...
public final class LegacyHybridEncryptKeyManagerTest {
  ...
  @Test
  public void testCreateHybridEncrypt_works() throws Exception {
    ...
    HybridDecrypt decrypt = HpkeDecrypt.create(privateKey);
    HybridEncrypt encrypt = encryptKeyManager.getPrimitive(protoPublicKey.toByteString());
