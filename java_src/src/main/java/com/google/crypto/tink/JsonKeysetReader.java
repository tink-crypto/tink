...
public final class JsonKeysetReader implements KeysetReader {
  ...
  public Keyset read() throws IOException {
    try {
      if (json != null) {
        ...
        return keysetFromJson(JsonParser.parseString(
            new String(Util.readAll(inputStream), UTF_8)).getAsJsonObject());
      }
  ...
  public EncryptedKeyset readEncrypted() throws IOException {
    try {
      if (json != null) {
        ...
        return encryptedKeysetFromJson(JsonParser.parseString(
            new String(Util.readAll(inputStream), UTF_8)).getAsJsonObject());
      }
    } catch (JsonParseException e) {
      throw new IOException(e);
  ...
  private Keyset keysetFromJson(JsonObject json) throws JsonParseException {
    validateKeyset(json);
  ...
  private EncryptedKeyset encryptedKeysetFromJson(JsonObject json) throws JsonParseException {
  ...
  private Keyset.Key keyFromJson(JsonObject json) throws JsonParseException {
    validateKey(json);
  ...
  private static KeysetInfo keysetInfoFromJson(JsonObject json) throws JsonParseException {
  ...
  private static KeysetInfo.KeyInfo keyInfoFromJson(JsonObject json) throws JsonParseException {
  ...
  private KeyData keyDataFromJson(JsonObject json) throws JsonParseException {
  ...
  private static KeyStatusType getStatus(String status) throws JsonParseException {
  ...
  private static OutputPrefixType getOutputPrefixType(String type) throws JsonParseException {
    if (type.equals("TINK")) {
  ...
  private static KeyMaterialType getKeyMaterialType(String type) throws JsonParseException {
  ...
  private static void validateKeyset(JsonObject json) throws JsonParseException {
    if (!json.has("key") || json.getAsJsonArray("key").size() == 0) {
      throw new JsonParseException("invalid keyset");
    }
  }

  private static void validateEncryptedKeyset(JsonObject json) throws JsonParseException {
    if (!json.has("encryptedKeyset")) {
      throw new JsonParseException("invalid encrypted keyset");
    }
  }

  private static void validateKey(JsonObject json) throws JsonParseException {
    if (!json.has("keyData")
        || !json.has("status")
        || !json.has("keyId")
  ...
  private static void validateKeyData(JsonObject json) throws JsonParseException {
