 ...
 *            key.getKeyFormat().getHashType() != HmacKeyFormat.Hash.SHA_256 ||
 *            key.getKeyFormat().getTagSizeBytes() != 20 ||
 *            key.getKeyFormat().getKeySizeBytes() != 32) {
 *          throw new IllegalArgumentException("KeyFormat not supported by receiver.");
 *        }
