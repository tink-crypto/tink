...
public final class JsonKeysetWriter implements KeysetWriter {
  ...
  private JsonObject toJson(Keyset keyset) throws JsonParseException {
  ...
  private JsonObject toJson(Keyset.Key key) throws JsonParseException {
    JsonObject json = new JsonObject();
  ...
  private JsonObject toJson(KeyData keyData) throws JsonParseException {
    JsonObject json = new JsonObject();
  ...
  private JsonObject toJson(EncryptedKeyset keyset) throws JsonParseException {
    JsonObject json = new JsonObject();
  ...
  private JsonObject toJson(KeysetInfo keysetInfo) throws JsonParseException {
    JsonObject json = new JsonObject();
  ...
  private JsonObject toJson(KeysetInfo.KeyInfo keyInfo) throws JsonParseException {
    JsonObject json = new JsonObject();
