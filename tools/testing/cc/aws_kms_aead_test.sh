...
TINK_BASE_DIR="${REPO_DIR}/tink_base"
AWS_KEY_ARN_FILE="${TINK_BASE_DIR}/testdata/aws_key_arn.txt"
CREDENTIALS_AWS_CSV_FILE="${TINK_BASE_DIR}/testdata/aws_credentials_cc.txt"
BAD_AWS_KEY_ARN_FILE="${TINK_BASE_DIR}/testdata/bad_aws_key_arn.txt"
BAD_CREDENTIALS_AWS_CSV_FILE="${TINK_BASE_DIR}/testdata/bad_aws_credentials_cc.txt"
