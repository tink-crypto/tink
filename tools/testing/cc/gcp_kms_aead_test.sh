...
GCP_KEY_NAME_FILE="${TINK_BASE_DIR}/testdata/gcp_key_name.txt"
CREDENTIALS_GCP_JSON_FILE="${TINK_BASE_DIR}/testdata/credential.json"
BAD_GCP_KEY_NAME_FILE="${TINK_BASE_DIR}/testdata/bad_gcp_key_name.txt"
BAD_CREDENTIALS_GCP_JSON_FILE="${TINK_BASE_DIR}/testdata/bad_gcp_credentials.json"
