 ...
 */
public class EnableKeyCommand extends KeyIdOptions implements Command {
  @Override
  public void run() throws Exception {
    validate();
    enable(outputStream, outFormat, inputStream, inFormat,
   ...
   */
  public static void enable(OutputStream outputStream, String outFormat,
      InputStream inputStream, String inFormat, String masterKeyUri,
      String credentialPath, int keyId) throws Exception {
    TinkeyUtil.manipulateKey(TinkeyUtil.CommandType.ENABLE_KEY, outputStream, outFormat,
