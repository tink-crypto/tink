...
bazel build --//config:use_only_fips=True --build_tag_filters=fips,-requires_boringcrypto_update -- ...
bazel test --//config:use_only_fips=True --build_tests_only --build_tag_filters=fips,-requires_boringcrypto_update --test_tag_filters=fips,-requires_boringcrypto_update -- ...
