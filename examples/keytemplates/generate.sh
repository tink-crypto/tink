...
--key-format "params{dem_params{aead_dem{type_url:\"type.googleapis.com/google.crypto.tink.AesGcmKey\",value:\"\020\020\"}}kem_params{hkdf_hash_type:SHA256,curve_type:NIST_P256}ec_point_format:UNCOMPRESSED}" > hybrid/ECIES_P256_HKDFHMACSHA256_AES128GCM.proto

tinkey create-key-template \
--type-url type.googleapis.com/google.crypto.tink.EciesAeadHkdfPrivateKey \
--key-format "params{dem_params{aead_dem{type_url:\"type.googleapis.com/google.crypto.tink.AesGcmKey\",value:\"\020 \"}}kem_params{hkdf_hash_type:SHA256,curve_type:NIST_P256}ec_point_format:UNCOMPRESSED}" > hybrid/ECIES_P256_HKDFHMACSHA256_AES256GCM.proto
