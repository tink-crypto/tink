...
##### Run encryption
test_command ${AEAD_CLI} encrypt ${KEYSET_FILE} ${DATA_FILE} "${DATA_FILE}".encrypted
...
##### Run decryption
test_command  ${AEAD_CLI} decrypt ${KEYSET_FILE} ${DATA_FILE}.encrypted "${DATA_FILE}".decrypted
