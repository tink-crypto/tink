...
LIBTINK_SO_FILE="external/tink_cc/libtink.so"
TINK_HEADERS_TAR_FILE="external/tink_cc/tink_headers.tar"
TINK_DEPS_HEADERS_TAR_FILE="external/tink_cc/tink_deps_headers.tar"
