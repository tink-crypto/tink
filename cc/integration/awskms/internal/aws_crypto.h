...
#ifndef TINK_INTEGRATION_AWSKMS_INTERNAL_AWS_CRYPTO_H_
#define TINK_INTEGRATION_AWSKMS_INTERNAL_AWS_CRYPTO_H_
...
#endif  // TINK_INTEGRATION_AWSKMS_INTERNAL_AWS_CRYPTO_H_
