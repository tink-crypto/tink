...
#ifndef TINK_EXPERIMENTAL_SIGNATURE_DILITHIUM_SIGN_KEY_MANAGER_H_
#define TINK_EXPERIMENTAL_SIGNATURE_DILITHIUM_SIGN_KEY_MANAGER_H_
...
#endif  // TINK_EXPERIMENTAL_SIGNATURE_DILITHIUM_SIGN_KEY_MANAGER_H_
