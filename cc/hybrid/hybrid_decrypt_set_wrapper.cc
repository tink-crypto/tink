...
crypto::tink::util::Status Validate(PrimitiveSet<HybridDecrypt>* hybrid_decrypt_set) {
...
HybridDecryptSetWrapper::NewHybridDecrypt(
  ...
  crypto::tink::util::Status status = Validate(hybrid_decrypt_set.get());
...
crypto::tink::util::StatusOr<std::string> HybridDecryptSetWrapper::Decrypt(
