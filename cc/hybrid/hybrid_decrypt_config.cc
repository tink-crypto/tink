...
// static
crypto::tink::util::Status HybridDecryptConfig::RegisterStandardKeyTypes() {
...
// static
crypto::tink::util::Status HybridDecryptConfig::RegisterLegacyKeyTypes() {
  return crypto::tink::util::Status::OK;
}

// static
crypto::tink::util::Status HybridDecryptConfig::RegisterKeyManager(
