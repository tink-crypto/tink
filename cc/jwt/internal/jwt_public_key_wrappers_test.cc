...
TEST_F(JwtPublicKeyWrappersTest, GenerateRawSignVerifySuccess) {
  ...
  EXPECT_THAT(jwt_sign.status(), IsOk());
  ...
  EXPECT_THAT(jwt_verify.status(), IsOk());
