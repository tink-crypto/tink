...
public class EllipticCurvesTest {
  ...
  static class TestVector1 {
    ...
    public TestVector1(
        EllipticCurves.CurveType curve, String pubX, String pubY) {
      this.curve = curve;
      this.pubX = pubX;
      this.pubY = pubY;
    }
  ...
  public static final TestVector1[] testVectors1 = new TestVector1[] {
    new TestVector1(EllipticCurves.CurveType.NIST_P256,
        ...
        new TestVector1(EllipticCurves.CurveType.NIST_P384,
        ...
        new TestVector1(EllipticCurves.CurveType.NIST_P521,
