...
public class DjbCipherPoly1305Test {
   ...
   */
  @Test
  public void testDjbCipherPoly1305() {
   ...
   */
  @Test
  public void testDjbCipherPoly1305TestVector1() {
    byte[] key = TestUtil.hexDecode(""
   ...
   */
  @Test
  public void testDjbCipherPoly1305TestVector2() {
    byte[] key = TestUtil.hexDecode(""
        + "00000000000000000000000000000000"
   ...
   */
  @Test
  public void testDjbCipherPoly1305TestVector3() {
    byte[] key = TestUtil.hexDecode(""
        + "36e5f6b5c5e06070f0efca96227a863e"
        + "00000000000000000000000000000000");
    byte[] in = ("Any submission to the IETF intended by the Contributor for publication as all or "
   ...
   */
  @Test
  public void testDjbCipherPoly1305TestVector4() {
    byte[] key = TestUtil.hexDecode(""
   ...
   */
  @Test
  public void testDjbCipherPoly1305TestVector5() {
    byte[] key = TestUtil.hexDecode(""
   ...
   */
  @Test
  public void testDjbCipherPoly1305TestVector6() {
    byte[] key = TestUtil.hexDecode(""
        + "02000000000000000000000000000000"
        + "ffffffffffffffffffffffffffffffff");
    byte[] in = TestUtil.hexDecode(""
   ...
   */
  @Test
  public void testDjbCipherPoly1305TestVector7() {
    byte[] key = TestUtil.hexDecode(""
   ...
   */
  @Test
  public void testDjbCipherPoly1305TestVector8() {
    byte[] key = TestUtil.hexDecode(""
        + "01000000000000000000000000000000"
        + "00000000000000000000000000000000");
    byte[] in = TestUtil.hexDecode(""
   ...
   */
  @Test
  public void testDjbCipherPoly1305TestVector9() {
    byte[] key = TestUtil.hexDecode(""
        + "02000000000000000000000000000000"
        + "00000000000000000000000000000000");
    byte[] in = TestUtil.hexDecode(""
   ...
   */
  @Test
  public void testDjbCipherPoly1305TestVector10() {
    byte[] key = TestUtil.hexDecode(""
   ...
   */
  @Test
  public void testDjbCipherPoly1305TestVector11() {
    byte[] key = TestUtil.hexDecode(""
        + "01000000000000000400000000000000"
        + "00000000000000000000000000000000");
    byte[] in = TestUtil.hexDecode(""
