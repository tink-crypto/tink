...
public class EcUtilTest {
  ...
  public static final TestVector[] testVectors = new TestVector[] {
    new TestVector(EllipticCurveType.NIST_P256,
        ...
        new TestVector(EllipticCurveType.NIST_P384,
        ...
        new TestVector(EllipticCurveType.NIST_P521,
