 ...
 * keysets in text format to common storage systems.
 */
public final class TextFormatKeysetWriters {
  ...
  private static class OutputStreamKeysetWriter implements KeysetWriter {
    ...
    public void write(Keyset keyset) throws IOException {
      byte[] output = TextFormat.printToUnicodeString(keyset).getBytes("UTF-8");
