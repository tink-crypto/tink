...
public final class EciesHkdfSenderKem {
  ...
  public KemKey generateKey(String hmacAlgo,
      final byte[] hkdfSalt,
      final byte[] hkdfInfo,
      int keySizeInBytes,
      EllipticCurves.PointFormatType pointFormat) throws GeneralSecurityException {
    ...
    byte[] kemBytes = EllipticCurves.ecPointEncode(
