 ...
 * accepts a {@link K2Context} and a {@link java.net.URI URI} address.
...
public interface StoreDriver {
   ...
   * <p>
   * If the open fails, the driver must ensure that any partially allocated
   * resources are freed; {@code close()} will not be called if {@code open()}
   * fails.
   * 
