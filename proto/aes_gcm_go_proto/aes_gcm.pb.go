...
package aes_gcm_go_proto // import "github.com/google/tink/proto/aes_gcm_go_proto"
...
func (*AesGcmKeyFormat) Descriptor() ([]byte, []int) {
	return fileDescriptor_7a96a9595b5ee48a, []int{0}
}
...
func (dst *AesGcmKeyFormat) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AesGcmKeyFormat.Merge(dst, src)
}
...
func (*AesGcmKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_7a96a9595b5ee48a, []int{1}
}
...
func (dst *AesGcmKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AesGcmKey.Merge(dst, src)
}
...
func init() { proto.RegisterFile("proto/aes_gcm.proto", fileDescriptor_7a96a9595b5ee48a) }

var fileDescriptor_7a96a9595b5ee48a = []byte{
	...
	0x12, 0xcc, 0x0a, 0x8c, 0x1a, 0x3c, 0x41, 0x20, 0x23, 0xc3, 0x40, 0x7c, 0xa7, 0x08, 0x2e, 0x99,
	0xe4, 0xfc, 0x5c, 0x3d, 0x4c, 0xb7, 0x40, 0x5c, 0x19, 0xc0, 0x18, 0xa5, 0x9b, 0x9e, 0x59, 0x92,
	0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x0f, 0x51, 0xa6, 0x0f, 0x92, 0xd7, 0x47, 0xf1, 0x53,
	0x7c, 0x7a, 0x7e, 0x3c, 0x58, 0x60, 0x11, 0x13, 0x5b, 0x88, 0xa7, 0x9f, 0x77, 0x80, 0x53, 0x12,
	0x1b, 0x98, 0x6f, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xb9, 0xf9, 0x64, 0xcd, 0xfd, 0x00, 0x00,
	0x00,
}
