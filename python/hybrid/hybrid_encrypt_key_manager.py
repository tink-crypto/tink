...
"""Python wrapper of the pybind-wrapped C++ Hybrid En- and Decryption key manager."""
...
from tink.python.cc.pybind import hybrid_encrypt as cc_hybrid_encrypt
...
class _HybridEncryptCcToPyWrapper(hybrid_encrypt.HybridEncrypt):
  """Transforms pybind C++ HybridEncrypt primitive into a Python primitive."""
