...
class AwsKmsAead(aead.Aead):
  """Provide AEAD primitive through GCP client."""

  def __init__(self, key_name: Text, client: boto3.client):
      """Create new GcpKmsAead bound to a key.
  ...
  def decrypt(self, ciphertext: bytes, associated_data: bytes) -> bytes:
    ...
    try:
      ...
      # TODO(kste): Change to tink_error when its moved to pybind11
      raise ValueError("Decryption failed.") #TODO: Change this to tink_error when ported
