...
const KEY_SIZE_IN_BYTES: number[] = [16, 32];

/**
 * Download from  @see https://csrc.nist.gov/Projects/Cryptographic-Algorithm-Validation-Program/CAVP-TESTING-BLOCK-CIPHER-MODES.
 * TODO(b/201071402): Add Wycheproof test vectors.
 */
