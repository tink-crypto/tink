...
goog.module('tink.hybrid.HybridDecryptSetWrapper');
...
class HybridDecryptSetWrapper {
  ...
  /**
   * @param {!PrimitiveSet.PrimitiveSet} hybridDecryptPrimitiveSet
   * @return {!HybridDecryptSetWrapper}
   */
  static newHybridDecrypt(hybridDecryptPrimitiveSet) {
    ...
    return new HybridDecryptSetWrapper(hybridDecryptPrimitiveSet);
  }
...
exports = HybridDecryptSetWrapper;
