...
- (void)test110Config {
  ...
  XCTAssertEqual(config.entry_size(), 21);
  ...
  XCTAssertTrue("TinkMac" == config.entry(1).catalogue_name());
  XCTAssertTrue("Mac" == config.entry(1).primitive_name());
  XCTAssertTrue(aes_cmac_key_type == config.entry(1).type_url());
  ...
  XCTAssertTrue(ecies_hybrid_decrypt_key_type == config.entry(9).type_url());
  ...
  XCTAssertTrue(ecies_hybrid_encrypt_key_type == config.entry(10).type_url());
  ...
  XCTAssertTrue(ecdsa_sign_key_type == config.entry(11).type_url());
  ...
  XCTAssertTrue(ecdsa_verify_key_type == config.entry(12).type_url());
  ...
  XCTAssertTrue(ed25519_sign_key_type == config.entry(13).type_url());
  ...
  XCTAssertTrue(ed25519_verify_key_type == config.entry(14).type_url());
  ...
  XCTAssertTrue("TinkPublicKeySign" == config.entry(15).catalogue_name());
  XCTAssertTrue("PublicKeySign" == config.entry(15).primitive_name());
  XCTAssertTrue(rsa_ssa_pss_sign_key_type == config.entry(15).type_url());
  ...
  XCTAssertTrue("TinkPublicKeyVerify" == config.entry(16).catalogue_name());
  XCTAssertTrue("PublicKeyVerify" == config.entry(16).primitive_name());
  XCTAssertTrue(rsa_ssa_pss_verify_key_type == config.entry(16).type_url());
  ...
  XCTAssertTrue("TinkPublicKeySign" == config.entry(17).catalogue_name());
  XCTAssertTrue("PublicKeySign" == config.entry(17).primitive_name());
  XCTAssertTrue(rsa_ssa_pkcs1_sign_key_type == config.entry(17).type_url());
  ...
  XCTAssertTrue("TinkPublicKeyVerify" == config.entry(18).catalogue_name());
  XCTAssertTrue("PublicKeyVerify" == config.entry(18).primitive_name());
  XCTAssertTrue(rsa_ssa_pkcs1_verify_key_type == config.entry(18).type_url());
  ...
  XCTAssertTrue("TinkDeterministicAead" == config.entry(19).catalogue_name());
  XCTAssertTrue("DeterministicAead" == config.entry(19).primitive_name());
  XCTAssertTrue(aes_siv_key_type == config.entry(19).type_url());
  ...
  XCTAssertTrue("TinkStreamingAead" == config.entry(20).catalogue_name());
  XCTAssertTrue("StreamingAead" == config.entry(20).primitive_name());
  XCTAssertTrue(aes_gcm_hkdf_streaming_key_type == config.entry(20).type_url());
  XCTAssertTrue(config.entry(20).new_key_allowed());
  XCTAssertEqual(config.entry(20).key_manager_version(), 0);
}
